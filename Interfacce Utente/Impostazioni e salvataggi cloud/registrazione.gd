...
onready var mailField :LineEdit = get_node("VBoxContainer/email")
onready var passField :LineEdit = get_node("VBoxContainer/pass")
onready var passConField :LineEdit = get_node("VBoxContainer/passconfirm")
